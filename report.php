...
// report logic below
	...
	else
	{
		...
		elseif($operator=='qatar_gamestation')
		{
			...
			$report="gamebardb_vodafone_qatar_report";
			$sql_ad="select * from gamesdblog_ooredoo_qatar_gamestation_ma.advertiser ";
			$res_ad=mysqli_query($con1,$sql_ad);
	...
	else if($operator=='ooredoo_oman')
	{
		if($product=='gamebar' || $product=='gamebar')
		{
			...
			if($end_date1 == $date1 && $start_date1 == $date1)
			{
					 ...
					 $sql="call gamesdb_ooredoo_oman_ma.mainreport1('".$start_date."','".$end_date."','0')";
				   ...
				   if($end_date1 == $date1 && $start_date1 == $date1)
					{
							...
							$sql="call gamesdb_ooredoo_qatar_gamestation_ma.mainreport1('".$start_date."','".$end_date."','0')";
	...
	else if($operator=='ooredoo_oman')
	{
		if($product=='gamebar' || $product=='gamebar')
		{
			...
			{	
							 ...
							 $sql="call gamesdb_ooredoo_oman_ma.mainreport1('".$start_date."','".$end_date."','".$advertiserid."')";
							$cc=1;
								$res=mysqli_query($con1,$sql) or die(mysqli_error());
			}
			elseif($end_date1 == $date1 && $start_date1 != $date1)
	...
	else if($operator=='qatar_gamestation')
	{
		...
		if($product=='gamebar' || $product=='gamebar')
		{
			...
			{	
							 ...
							 $sql="call  gamesdb_ooredoo_qatar_gamestation_ma.mainreport1('".$start_date."','".$end_date."','".$advertiserid."')";
							$cc=1;
								$res=mysqli_query($con1,$sql) or die(mysqli_error());
			}
			elseif($end_date1 == $date1 && $start_date1 != $date1)
