	...
	{//vodafone
		if($product=='gamebar' || $product=='gamebar')
		{
			...
			if($end_date1 == $date1 && $start_date1 == $date1)
			{
					...
					echo $sql="call ".$db.".mainreport('".$start_date."','".$end_date."','')";
			...
			elseif($end_date1 == $date1 && $start_date1 != $date1)
			{
				...
				*/
					$sql="call ".$db.".mainreport('".$start_date."','".$end_date."','')";
					$cc=2;
					$res=mysqli_query($con1,$sql) or die(mysqli_error());
			/*}
			else
	...
	else if($operator=='ooredoo_oman')
	{
		if($product=='gamebar' || $product=='gamebar')
		{
			...
			if($end_date1 == $date1 && $start_date1 == $date1)
			{
					 ...
					 $sql="call ".$db.".mainreport1('".$db."','".$dblog."','".$start_date."','".$end_date."','')";
	...
	else if($operator=='south-africa')
	{
		if($product=='gamebar' || $product=='gamebar')
		{
			if($end_date1 == $date1 && $start_date1 == $date1)
			{
					...
					$sql="call ".$db.".mainreport_gamebar('".$start_date."','".$end_date."','')";
	...
	else if($operator=='all_greece')
	{
		if($product=='gamebar' || $product=='gamebar')
		{
			if($end_date1 == $date1 && $start_date1 == $date1)
			{
					...
					$sql="call ".$db.".grmainreport('".$start_date."','".$end_date."','')";
	...
	else if($operator=='sweden')
	{
		if($product=='gamebar' || $product=='gamebar')
		{
			if($end_date1 == $date1 && $start_date1 == $date1)
			{
					...
					$sql="call ".$db.".swedenmainreport('".$start_date."','".$end_date."','')";
	...
	else if($operator=='vodacom_wfh')
	{
		if($product=='gamebar' || $product=='gamebar')
		{
			...
			{*/
					...
					$sql="call ".$db.".mainreport('".$start_date."','".$end_date."','',1)";
	...
	else if($operator=='vodacom_fg')
	{
		if($product=='gamebar' || $product=='gamebar')
		{
			...
			{*/
					...
					$sql="call ".$db.".mainreport('".$start_date."','".$end_date."','',2)";
		...
		if($product=='gamebar' || $product=='gamebar')
		{
			...
			/*if($end_date1 == $date1 && $start_date1 == $date1)
			{
				*/
					...
					$sql="call ".$db.".mainreport('".$start_date."','".$end_date."','',3)";
...
else
{
	...
	else if($operator=='airtel_india')
	{
		if($product=='gamebar' || $product=='gamebar')
		{
			...
			elseif($end_date1 == $date1 && $start_date1 != $date1)
			{
				$sql1="select * from ".$report.".mainreport where date >='".$start_date."' and date < SUBDATE('".$end_date."', INTERVAL 1 DAY) and operator='".$operator."' and product='".$product."' and advertiser='".$advertiserid."'";
				$res1=mysqli_query($con,$sql1);
			...
			{
				 $sql="select * from ".$report.".mainreport where date >='".$start_date."' and date < '".$end_date."' and  operator='".$operator."' and product='".$product."' and advertiser='".$advertiserid."'" ;
				$cc=3;
				$res=mysqli_query($con,$sql) or die(mysqli_error());
			}
		}
							...
							//echo $sql;
								...
								?>
									<tr>
										...
										else if($operator=='poland' or $operator=='Cosmote_Greece' or $operator=='Vodafone_Greece'  or $operator=='all_greece')
										{
										?>	
										<td><?php echo number_format($damount*0.45,2,'.',''); $svmobiamount_sum=$svmobiamount_sum+$damount*0.45;?></td>
										<?php
										}
										else if($operator=='indonesia' or $operator=='Wind_Greece')
										{
										?>	
										...
										{
										?>	
										<td><?php echo number_format($damount*0.25); $svmobiamount_sum=$svmobiamount_sum+$damount*0.25;?></td>
										<?php
										}
										else if($operator=='Bangladesh_Robi')
										{
								...
								?>
									<tr>
										...
										{
										?>	
										<td><?php echo number_format($damount*0.4,2,'.',''); $svmobiamount_sum=$svmobiamount_sum+$damount*0.4;?></td>
										<?php
										}
										else if($operator=='kazakistan' )
										{
										?>	
										<td><?php echo number_format($damount*0.25,2,'.',''); $svmobiamount_sum=$svmobiamount_sum+$damount*0.25;?></td>
										<?php
										}
										else if($operator=='Bangladesh_Robi')
										{
...
function myfun() {
	...
	//	select.options[select.options.length] = new Option('Hotshots_Airtel', 'hotshots_airtel');
