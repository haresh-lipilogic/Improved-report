...
//include("includes/dbo.php");
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="select * from gamebardb_vodafone_qatar_report.login where username='$username' and password='$password' ";
		$res=$conn->query($sql);
		$row=$res->fetch();
	 	//echo $num=$res->fetchRow(); exit;
		//echo "ddd".$row['admin'];exit;
          ...
          <section class="login_content">
            <form method="post">
              ...
              <div class="separator">
                ...
                <br />
                <div>
                  <h1><i class="fa fa-paw" style="font-size: 26px;"></i> Loop360</h1>

                  <p>©2015 All Rights Reserved. Powered & Developed by Loop360</p>
                </div>
              </div>
            </form>
          </section>
