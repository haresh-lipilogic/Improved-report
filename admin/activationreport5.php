					  ...
					  <div class="x_content"  style="overflow:auto;">
						...
						<table  class="table  table-bordered">
						 ...
						 <tr>
							...
							<?php if($ll['Gamebar']['Cambodia']=='Open'){ echo "<th><center>Cambodia</center></th>"; }?>
							...
							<?php if($ll['Gamebar']['Spain']=='Open'){ echo "<th><center>Spain</center></th>"; }?>
							<?php if($ll['Gamebar']['Srilanka']=='Open'){ echo "<th><center>Srilanka</center></th>"; }?>
							<?php if($ll['Gamebar']['Sweden']=='Open'){ echo "<th><center>Sweden</center></th>"; }?>
							...
							<?php if($ll['Glambar']['Spain']=='Open'){ echo "<th><center>Spain</center></th>"; }?>
...
<?php if($ll['Gamebar']['Cambodia']=='Open'){ echo "<td>".$row['gamebar_cambodia']."</td>"; }?>
...
<?php if($ll['Gamebar']['Spain']=='Open'){ echo "<td>".$row['gamebar_spain']."</td>"; }?>
<?php if($ll['Gamebar']['Srilanka']=='Open'){ echo "<td>".$row['gamebar_srilanka']."</td>"; }?>
<?php if($ll['Gamebar']['Sweden']=='Open'){ echo "<td>".$row['gamebar_sweden']."</td>"; }?>
...
<?php if($ll['Glambar']['Spain']=='Open'){ echo "<td>".$row['Glambar_spain']."</td>"; }?>
...
<?php if($ll['Contest']['Qatar']=='Open'){ echo "<td>".$row['contest_qatar']."</td>"; }?>
				...
				if($c==1)
				{
					//echo "hi2";
						...
						$result1 = $con1->query("call game_cambodia_apigate.getactivation('".$start_date."',  '".$end_date."', ".$hours.") ");
						$rows=mysqli_num_rows($result1);
						
						while($row1=mysqli_fetch_array($result1))
						{
							$game_cambodia=$row1['act'];
							$malaysiadt=$row1['dt'];
					...
					//	echo"call fashionbardb_greeceglam.get_activation('".$start_date."',  '".$end_date."', ".$hours.")";
						...
						$gamebar_jordan=$gamebar_jordan1+$gamebar_jordanum;
...
<?php if($ll['Gamebar']['Cambodia']=='Open'){ echo "<td>".$game_cambodia."</td>"; }?>
...
<?php if($ll['Gamebar']['Spain']=='Open'){ echo "<td>".$gamebar_spain."</td>"; }?>
<?php if($ll['Gamebar']['Srilanka']=='Open'){ echo "<td>".$gamebar_srilanka."</td>"; }?>
<?php if($ll['Gamebar']['Sweden']=='Open'){ echo "<td>".$gamebar_sweden."</td>"; }?>
...
<?php if($ll['Glambar']['Spain']=='Open'){ echo "<td>".$glambar_spain."</td>"; }?>
