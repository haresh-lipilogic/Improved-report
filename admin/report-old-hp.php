...
//	$cc=1;
	...
	*/
	...
	$query=str_replace("[advid]",$adve,$url);
			...
			{
					$sql1="select * from ".$report.".mainreport where date >='".$start_date1."' and date < SUBDATE('".$end_date."', INTERVAL 1 DAY) and advertiser='".$adve."' and operator='".$operator."' and product='".$product."'";
			...
			{
				 $sql="select * from ".$report.".mainreport where date >='".$start_date1."' and date < '".$end_date."' and advertiser='".$adve."' and operator='".$operator."' and product='".$product."'";
        ...
        <div class="right_col" role="main" >
          <div class="footer_down">
			...
			//echo $operator;
				...
				{
					echo "DigitalCost=".$cost=$wor['operator_cost'];
				}
							...
							//echo $sql;
								...
								?>
									<tr>
										...
										<td><?php echo number_format($churn); $churn_sum=$churn_sum+$churn;?></td>
								...
								<tr>
									...
									<td><?php echo  number_format($actamnt_sum);?></td>
									<td><?php echo number_format($ren_sum); ?></td>
									<td><?php echo number_format($renamnt_sum); ?></td>
									<td><?php echo number_format($count_sum); ?></td>
									<td><?php echo number_format($amount_sum); ?></td>
									<td><?php echo number_format($svmobiamount_sum); ?></td>
									<td><?php echo number_format($churn_sum); ?></td>
									<td><?php echo number_format($low_sum); ?></td>
									<td><?php echo number_format($cbsent_sum); ?></td>
									<td></td>
									<td><?php echo number_format($advcost_sum); ?></td>
