...
mysqli_query($con1,"DELETE FROM ".$report.".`mainreport` WHERE `date`='".$date1."' and operator like '%vodacom%' ;") or die(mysqli_error($con1));

//echo"hi";exit;
//all


$sql1="select * from  gamebardb_vodafone_qatar_report.mainreportquery where operator like '%vodacom%' order by id asc";
