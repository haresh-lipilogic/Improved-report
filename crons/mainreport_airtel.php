...
mysqli_query($con1,"DELETE FROM ".$report.".`mainreport` WHERE `date`='".$date1."' and operator='airtel_india';") or die(mysqli_error($con1));
						...
						GROUP BY dt;";									
						  ...
						  $sql1="select advertiserid from ".$gamebar_airtel.".advertiser";					
							...
							//	echo $result3; exit;
								...
								$count=mysqli_num_rows($result30);
