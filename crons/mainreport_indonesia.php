...
mysqli_query($con1,"DELETE FROM ".$report.".`mainreport` WHERE `date`='".$date1."' and operator='indonesia' ;") or die(mysqli_error($con1));
							...
							//	echo $result3; exit;
								//echo "hi";
									while($row5=mysqli_fetch_array($result30,MYSQLI_ASSOC))
									{
										...
										echo   $sql2="call ".$indonesia.".mainreport_backdate('".$startdate."','".$enddate."','".$advertiserid."')";
