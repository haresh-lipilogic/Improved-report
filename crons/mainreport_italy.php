...
mysqli_query($con1,"DELETE FROM ".$report.".`mainreport` WHERE `date`='".$date1."' and (operator='tim_italy' or operator='wind_italy' or operator='h3g_italy');") or die(mysqli_error($con1));
