...
echo  $date1=date('Y-m-d',strtotime("-5 days"));
...
$glambar_southafrica_intarget='glambardb_southafrica';
 ...
 mysqli_query($con1,"DELETE FROM ".$report.".`mainreport` WHERE `date`='".$date1."' and operator='southafrica_intarget' and product='glambar' ;") or die(mysqli_error($con1));
