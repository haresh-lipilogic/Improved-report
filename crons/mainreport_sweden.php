...
mysqli_query($con1,"DELETE FROM ".$report.".`mainreport` WHERE `date`='".$date1."' and operator in ('sweden')  ;") or die(mysqli_error($con1));
...
//Vodacom_worldforher
								...
								echo "<br>".$sql="call ".$gamebar_sweden.".mainreport('".$startdate."','".$enddate."','0')";
						...
						$sql1="select advertiserid,advname from ".$gamebar_sweden.".advertiser";					
							...
							//	echo $result3; exit;
								//echo "hi";
									while($row5=mysqli_fetch_array($result30,MYSQLI_ASSOC))
									{
										...
										echo "<br>".  $sql2="call ".$gamebar_sweden.".mainreport('".$startdate."','".$enddate."','".$advertiserid."')";
