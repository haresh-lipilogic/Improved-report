...
mysqli_query($con1,"DELETE FROM ".$report.".`mainreport` WHERE `date`>='".$start."' and `date` <='".$end."' and country  like '%".$country."%' ;") or die(mysqli_error($con1));

//echo"hi";exit;
//all


$sql1="select * from  gamebardb_vodafone_qatar_report.mainreportquery  where country like '%".$country."%' order by id asc";
