...
//exit;
	...
	$sql1="delete from gamebardb_vodafone_qatar_report.`subdashboard` where date>='".$start_date."' and date<='".$end_date."'";
...
ORDER BY country,product,operator";
	...
	//echo $sql;exit;
			...
			echo 	$sql1="INSERT INTO gamebardb_vodafone_qatar_report.`subdashboard`(`date`, `country`,`product`,`operator`, `actcount`, `actamount`, `rencount`, `renamount`, `totalcount`, `totalamount`, `digiinvest`, `svmobirevenue`, `profit`,`ptotalamount`, `pdigiinvest`, `psvmobirevenue`, `pprofit`) values ('".$start_date."','".$country."','".$product."','".$operator."','".$actcount."','".$actamount."','".$rencount."','".$renamount."','".$totalcount."','".$totalamt."','".$digitin."','".$revenue."','".$profit."','".$ptotalamount."','".$pdigitalinvest."','".$psvmobirevenue."','".$pprofit."');";
