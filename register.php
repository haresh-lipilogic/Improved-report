...
if (isset($_POST['submit']))
{
	...
	$adv_product=$_POST['adv_product'];
	$adv_advertiser=implode(',',$_POST['adv_advertiser']);
	
	do_register($adv_name,$adv_email,$adv_number,$adv_website,$adv_password,$adv_product,$adv_advertiser);
}
?>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal"  method="post" action="register.php">
					  ...
					  <div class="item form-group" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" id="product" name="adv_product" required  >
							<option value="">Select Product</option>
							<option value="hotshots">HotShots</option>
							<option value="games">GamezZone</option>
						  </select>
                        </div>
                      </div>
					  
					  <div class="item form-group response" >
