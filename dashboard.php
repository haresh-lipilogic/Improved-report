							...
							<tbody>
								...
								?>
									...
									?>
										...
										<td><?php echo number_format($pprofit,0,'.',',');?> </td>
										<?php $k=0;
										$k=number_format($dd=($ptotal-$row['lastmonthrevenue'])/$ptotal,2,'.','');
											
										?>
										<td <?php if($k<0){?> style="color:white;font-weight:bold;background:red;padding:5px;" <?php }else { ?> style="color:white;font-weight:bold;background:green;padding:5px;" <?php } ?>><?php echo number_format($dd*100,0,'.',',')."%";?> </td>
								...
								<td><?php echo number_format($totalact,0,'.',',');?> </td>
										<td><?php echo number_format($totalactamount,0,'.',',');?> </td>
										<td><?php echo number_format($totalrenewcount,0,'.',',');?> </td>
										<td><?php echo number_format($totalrenewamount,0,'.',',');?> </td>
										<td><?php echo number_format($totaltotalcount,0,'.',',');?> </td>
										<td><?php echo number_format($totaltotalamount,0,'.',',');?> </td>
										<td><?php echo number_format($totaldigiinvest,0,'.',',');?> </td>
										<td><?php echo number_format($totalrevenue,0,'.',',');?> </td>
										<td><?php echo number_format($totalprofit,0,'.',',');?> </td>
										<td><?php echo number_format($totalptotal,0,'.',',');?> </td>
										<td><?php echo number_format($totalpdigitin,0,'.',',');?> </td>
										<td><?php echo number_format($totalprevenue,0,'.',',');?> </td>
										<td><?php echo number_format($totalpprofit,0,'.',',');?> </td>
										<td><?php echo number_format($totalgrowth,0,'.',',').'%' ;?> </td>
